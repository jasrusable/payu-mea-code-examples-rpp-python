...
def payuMeaGetTransactionApiCall(args):	
...
if __name__ == '__main__':
	try:
		...
		transactionDetails['additionalInformation']['payUReference'] = 11998836694;	
		
		payuMeaGetTransactionApiCall(transactionDetails)
